...
DEFAULT_PROJECTS = [
    ...
    {
        "id": "fashion-ecommerce", "number": "03", "category": "E-commerce",
        "name": "Fashion Virus — E-commerce + WhatsApp Leads",
        "description": "A men's fashion online store with a smart WhatsApp shopping assistant. Customers message +91 93035 36612 to find shirts by colour, size and budget — AI shows product cards with prices and links to the website, while our team manages every lead and order from one dashboard.",
        "year": "2025", "role": "Full Stack + WhatsApp Automation",
        "tags": ["React", "WhatsApp API", "AI Automation"],
        "images": [_shot("fashion-1"), _shot("fashion-2"), _shot("fashion-3")],
