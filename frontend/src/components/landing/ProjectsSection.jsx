...
const FALLBACK = [
    ...
    },
    {
        ...
        description:
            "Full-featured travel agency platform where customers browse curated trip packages, plan itineraries, book holidays online, and manage their journeys — all in one place.",
        year: "2025",
        role: "Full Stack Development",
        tags: ["React", "Next.js", "Tailwind CSS"],
        images: [shot("travel-1"), shot("travel-2"), shot("travel-3")],
        live_url: "#",
    },
];
